...
public class EasyRTMP implements Pusher {
     ...
     * @param key 授权码
     */
    public native long init(String url, Context context, OnInitPusherCallback callback, int videoCodec, int fps, int audiosamplerate, int audiochannelcount);
    ...
    public synchronized void initPush(final String url, final Context context, final InitCallback callback, int fps) throws IllegalStateException {
        ...
        mPusherObj = init(url, context, new OnInitPusherCallback() {
